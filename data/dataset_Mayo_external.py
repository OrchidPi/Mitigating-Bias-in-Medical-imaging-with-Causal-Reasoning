...
class ImageDataset_Mayo_test(Dataset):
    def __init__(self, label_path, cfg, mode='train'):
        ...
        label_columns_indices = [-1]  # MACE_6mo, MACE_1yr, MACE_2yr, MACE_5yr
        bias_columns_indices = [3,4,9]
        with open(label_path) as f:
            ...
            #for i, line in enumerate(f):
                ...
                fields = line.strip('\n').split(',')
                if fields[-3] != '0':
                    continue  # Skip this line if "view" equals '1'
                #print(f"fields:{fields}")
               # image_path = fields[1][1:]
                image_path = fields[6]
                print(f"image_path: {image_path}")
                #print("inverted:", fields[-2], "view:", fields[-3])
                if fields[-2] == 'TRUE':
    ...
    def __getitem__(self, idx):
        ...
        save_indices = [100, 500, 1000, 1500, 2000, 2500, 3000]
       
        if idx in save_indices:
            folder_name = "/home/jialu/Datacenter_storage/jialu/saved_images_new"
